...
import com.liferay.docs.guestbook.util.CustomPortletKeys;
...
public class GuestbookIndexer extends BaseIndexer {
	...
	public static final String PORTLET_ID = CustomPortletKeys.GUESTBOOK_ADMIN;
	...
	public boolean hasPermission(
		PermissionChecker permissionChecker, String guestbookClassName,
		long guestbookClassPK, String actionId)
		throws Exception {

		Guestbook guestbook =
			GuestbookLocalServiceUtil.fetchGuestbook(guestbookClassPK);
	...
	protected Document doGetDocument(Object obj)
		...
		document.addKeyword(
			Field.GROUP_ID, getSiteGroupId(guestbook.getGroupId()));
	...
	protected void doReindex(Object obj)
		...
		SearchEngineUtil.updateDocument(
			getSearchEngineId(), guestbook.getCompanyId(), document, true);
	}
	...
	protected void reindexEntries(long companyId)
		...
		ActionableDynamicQuery actionableDynamicQuery =
			new GuestbookActionableDynamicQuery() {
		...
		SearchEngineUtil.updateDocuments(
			getSearchEngineId(), companyId, documents, true);
	}
}
